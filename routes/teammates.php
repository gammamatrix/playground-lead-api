...
Route::group([
    ...
    ])->can('index', Teammate::class);

    Route::post('/index', [
        'as' => 'playground.lead.api.teammates.index',
        'uses' => 'TeammateController@index',
    ])->can('index', Teammate::class);
