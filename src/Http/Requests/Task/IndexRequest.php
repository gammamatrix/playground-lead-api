...
/**
 * \Playground\Lead\Api\Http\Requests\Task\IndexRequest
 */
class IndexRequest extends BaseIndexRequest
{
    ...
    protected array $paginationIds = [
        ...
        'task_type' => ['column' => 'task_type', 'label' => 'Task Type', 'type' => 'string', 'nullable' => true],
    ...
    protected array $sortable = [
        ...
        'task_type' => ['column' => 'task_type', 'label' => 'Task Type', 'type' => 'string'],
